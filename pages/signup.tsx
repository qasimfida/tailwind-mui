      ...
      <Container maxWidth="lg">
        <Grid item>
          <Box className={classes.topContent}>
              <span className="text-4xl font-bold text-black">Hello! Welcome.</span>
              <br />
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <h1 className="pb-2 font-bold">First Name</h1>
            <TextField
              id="first-name"
              label="First Name*"
              variant="filled"
          ...
          <Grid item xs={12} md={6}>
            <h1 className="pb-2 font-bold">Last Name</h1>
            <TextField
              id="last-name"
              label="Last Name*"
              variant="filled"
          ...
          <Grid item xs={12} md={6}>
            <h1 className="pb-2 font-bold">Pin</h1>
            <TextField
              id="pin"
              label="PIN"
              variant="filled"
          ...
          <Grid item xs={12} md={6}>
            <h1 className="pb-2 font-bold">Code number</h1>
            <TextField
              id="code-number"
              label="Code Number*"
              variant="filled"
          ...
          <Grid item xs={12} md={6}>
            <h1 className="pb-2 font-bold">YOUR JOB TITLE</h1>
            <TextField
              id="job-title"
              label="Job Title"
              variant="filled"
          ...
          <Grid item xs={12} md={6}>
            <h1 className="pb-2 font-bold">Phone Number</h1>
            <TextField
              id="phone-number"
              label="Phone Number*"
              variant="filled"
          ...
          <Grid item xs={12} md={6}>
            <h1 className="pb-2 font-bold">Create Password</h1>
            <TextField
              id="password"
              label="Password*"
              variant="filled"
          ...
          <Grid item xs={12} md={6}>
            <h1 className="pb-2 font-bold">Retype Password</h1>
            <TextField
              id="confirm-password"
          ...
          <Grid item xs={12}>
            ...
            <Button variant="contained" onClick={handleSubmit} size="large" style={{color: "white", backgroundColor: "grey"}}>
              Submit
            </Button>
          </Grid>
        </Grid>
        <Modal
          ...
          >
            ...
            <Box style={{marginTop: theme.spacing(5)}}>
              <Button variant="outlined" onClick={handleModalClose} size="large" style={{color: "grey", borderColor: "grey", marginRight: theme.spacing(4)}}>
                Decline
              </Button>
              <Button variant="contained" onClick={handleModalClose} size="large" style={{color: "white", backgroundColor: "grey"}}>
              Agree
              </Button>
            </Box>
          </Box>
